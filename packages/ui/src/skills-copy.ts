...
const SKILLS_COPY = {
  ...
  'zh-TW': {
    ...
    market: { categoryAll: '全部分類', sortName: '排序：名稱', sortRecent: '排序：最近', controls: '市場篩選與排序', categoryFilter: '按分類篩選市場技能', sortAriaLabel: '市場技能排序方式', ariaLabel: '技能市場', importLocal: '匯入本地 Skill', emptySearchTitle: '沒有匹配的市場技能', emptyTitle: '來源庫還是空的', emptySearchBody: '換一個關鍵詞，或清空搜尋檢視全部來源。', emptyBody: '匯入一個含 SKILL.md 的本地檔案，它會作為可安裝的來源出現在這裡。', emptyFilterBody: '換一個分類或關鍵詞，或清空篩選檢視全部來源。', clearSearch: '清空搜尋', clearFilters: '清空篩選', sourceFallback: '本地來源庫 Skill。' },
    tabs: { ariaLabel: '技能檢視', market: '市場', builtin: '內建', installed: '已安裝' },
    install: { action: (name) => `安裝 ${name}`, installedAction: (name) => `${name} 已安裝到目前工作區`, installedTitle: '已安裝到目前工作區', installed: '已安裝', notInstalled: '未安裝' },
    builtin: { ariaLabel: '內建技能', emptyTitle: '暫無內建技能', emptyBody: '應用自帶的技能會出現在這裡。', noMatchTitle: '沒有匹配的內建技能', noMatchBody: '換一個關鍵詞，或清空搜尋檢視全部內建技能。', fallback: '應用自帶 Skill。', toolCount: (count: number) => `${count} 個工具` },
    installed: { emptySearchTitle: '沒有匹配的 Skill', emptyTitle: '等待新增 Skill', emptySearchBody: '換一個關鍵詞，或清空搜尋檢視全部本地技能。', emptyBodyBeforeCode: '把一個含', emptyBodyAfterCode: '的資料夾放到工作區的 skills/ 目錄下，重新整理後會出現在這裡。', refreshPending: '重新整理中…', refresh: '重新整理技能', listAriaLabel: '技能列表' },
    ...
    page: { title: '技能', toolbarAria: '技能篩選與檢視', metaInstalled: (count) => `${count} 個已安裝`, metaUpdates: (count) => `${count} 個可更新`, metaAvailable: (count) => `${count} 個可安裝`, searchMatches: (count) => `${count} 個匹配`, search: '搜尋技能', openFolder: '開啟目錄', moreActions: '更多技能操作', refreshing: '重新整理中…', refresh: '重新整理' },
