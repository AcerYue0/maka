...
export function subscriptionResultMessage(message: string | undefined, fallback: string, locale: UiLocale = 'zh-CN'): string {
  ...
  return locale !== 'en' || !/[\u4e00-\u9fff]/.test(raw) ? raw : fallback;
}
